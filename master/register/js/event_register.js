$(document).ready(function(){
    $("#event_register_button").on("click",function(){
        ...
        const arg_arr = {
            ...
            ,start_month:form_arr["end_day"].split("-")[1]
            ...
            ,start_second:form_arr["start_time"].split("-")[2]
            ,end_second:form_arr["end_time"].split("-")[2]
        }

        call_stored_js("register_event",arg_arr).then(function(data){
            console.log(data);
        },function(data){
            console.log(data);
        });
